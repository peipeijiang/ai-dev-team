    ...
    try {
        ...
        if (storyboardData && storyboardData.shots) {
            shots.value = storyboardData.shots.map((shot: any) => ({
                ...
                image_url: shot.image ? `/api/data/works/${workId}/episodes/${episodeId}/images/${shot.image}` : '',
                video_url: shot.video ? `/api/data/works/${workId}/episodes/${episodeId}/videos/${shot.video}` : '',
                audio_url: shot.audio ? `/api/data/works/${workId}/episodes/${episodeId}/audio/${shot.audio}` : ''
            }));
        }
    } catch (e) {
