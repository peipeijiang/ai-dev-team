...
web_modern_dist = os.path.join(project_root, "apps", "web-modern", "dist")
web_legacy = os.path.join(project_root, "apps", "web")

if os.path.exists(web_modern_dist):
    app.mount("/", StaticFiles(directory=web_modern_dist, html=True), name="web-modern")
    print(f"Serving modern frontend from: {web_modern_dist}")
elif os.path.exists(web_legacy):
    app.mount("/", StaticFiles(directory=web_legacy, html=True), name="web-legacy")
    print(f"Serving legacy frontend from: {web_legacy}")
else:
